...
public RemoteWebDriver driver;
  ...
  public void run() {
	  ...
	  try
	  {
		...
		WebElement name=driver.findElement(By.xpath("//input[@name='zee-login-username-two']"));
		name.sendKeys("test.lead");
		WebElement pwd=driver.findElement(By.xpath("//input[@name='zee-login-password-two']"));
		pwd.sendKeys("test.lead");
